...
import { LayoutGrid, Moon, Sun, Kanban, BarChart3, ListChecks, LogOut, UserPlus, X, Zap, Check } from "lucide-react";
...
export default function Navbar() {
  ...
  return (
    <nav className="relative z-50 flex items-center justify-between h-14 px-5 border-b border-[#ead7c3] dark:border-white/[0.06] bg-[#fbf6ef]/80 dark:bg-[#12121a]/80 backdrop-blur-md">
      ...
      <div className="hidden md:flex items-center bg-[#dce0d9] dark:bg-white/[0.04] rounded-lg p-0.5">
        {views.map((v) => (
          <button
            key={v.id}
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-[12px] font-medium transition-colors ${
              activeView === v.id
                ? "bg-[#fbf6ef] dark:bg-white/[0.08] text-gray-900 dark:text-white shadow-sm dark:shadow-none"
